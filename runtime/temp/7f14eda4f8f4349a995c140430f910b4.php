<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\WWW\tp0301/application/admin\view\attribute\attradd.html";i:1532050313;s:48:"D:\WWW\tp0301/application/admin\view\layout.html";i:1531811546;}*/ ?>
					...
					<div class="tab-content default-tab" id="tab2">
						...
						<form action="" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>属性选项</label>
										<input class="text-input small-input" type="text" id="small-input" name="options" /><font color="red">各个选项以逗号隔开</font>
								</p>
