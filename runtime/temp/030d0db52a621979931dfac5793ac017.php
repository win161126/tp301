<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\WWW\tp0301/application/admin\view\role\rolelist.html";i:1531193757;s:48:"D:\WWW\tp0301/application/admin\view\layout.html";i:1531280395;}*/ ?>
						...
						<table>
							...
							<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a href="<?php echo url('Role/roleUpdate',['id'=>$v['id']]); ?>" title="Edit"><img src="__PUBLIC__images/icons/pencil.png" alt="Edit" /></a>
										 <a href="<?php echo url('Role/roleDelete',['id'=>$v['id']]); ?>" title="Delete"><img src="__PUBLIC__images/icons/cross.png" alt="Delete" /></a> 
