<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\WWW\tp0301/application/admin\view\type\typelist.html";i:1532049792;s:48:"D:\WWW\tp0301/application/admin\view\layout.html";i:1531811546;}*/ ?>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3><a href="<?php echo url('typeAdd'); ?>">添加类型</a></h3>
						...
						<table>
							...
							<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
								<tr>
									...
									<td><a href="<?php echo url('Attribute/attrList',['typeid'=>$v['id']]); ?>">属性列表</a></td>
									<td>
										<!-- Icons -->
										 <a href="<?php echo url('Type/typeUpdate',['id'=>$v['id']]); ?>" title="Edit"><img src="__PUBLIC__images/icons/pencil.png" alt="Edit" /></a>
										 <a href="<?php echo url('Type/typeDelete',['id'=>$v['id']]); ?>" title="Delete"><img src="__PUBLIC__images/icons/cross.png" alt="Delete" /></a> 
