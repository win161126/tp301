<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"D:\WWW\tp0301/application/admin\view\role\roleadd.html";i:1531293537;s:48:"D:\WWW\tp0301/application/admin\view\layout.html";i:1531280395;}*/ ?>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p class="level">
									...
									<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
										<prev>
										<?php if($v['fid'] == 0): ?>
										<b style="display:block"><input type="checkbox" name="level[]" value="<?php echo $v['id']; ?>"><?php echo $v['name']; ?></b>
										<?php endif; if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;if($vv['fid'] == $v['id']): ?>
											<span><input type="checkbox" name="level[]" value="<?php echo $vv['id']; ?>"><?php echo $vv['name']; ?></span>
								...
								<p>
									<input class="button all" type="button" value="全选" />
									<input class="button noall" type="button" value="取消全选" />
