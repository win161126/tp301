<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"D:\WWW\tp0301/application/admin\view\manager\managerlist.html";i:1530586873;s:48:"D:\WWW\tp0301/application/admin\view\layout.html";i:1531208174;}*/ ?>
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					...
					<ul>
						<li><a href="<?php echo url('Manager/managerAdd'); ?>">添加管理员</a></li>
						<li><a href="<?php echo url('Manager/managerList'); ?>">管理员列表</a></li>
					</ul>
				</li>
				<li>
					<a href="#" class="nav-top-item">
						...
						<table>
							...
							<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a href="<?php echo url('Brand/brandUpdate',['id'=>$v['id']]); ?>" title="Edit"><img src="__PUBLIC__images/icons/pencil.png" alt="Edit" /></a>
										 <a href="<?php echo url('Brand/brandDelete',['id'=>$v['id']]); ?>" title="Delete"><img src="__PUBLIC__images/icons/cross.png" alt="Delete" /></a> 
