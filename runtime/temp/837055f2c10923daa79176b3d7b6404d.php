<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:50:"D:\WWW\tp0301/application/index\view\cart\pay.html";i:1531968334;s:55:"D:\WWW\tp0301/application/index\view\public\header.html";i:1531793643;s:55:"D:\WWW\tp0301/application/index\view\public\footer.html";i:1531359406;}*/ ?>
...
<div class="main">
    ...
    订单编号：<?php echo $orderid; ?><br /><br /><br />总价：￥<b style="color:red;margin-right:100px;"><?php echo $total; ?></b>
...
$(function(){
    $('.gw_btn').click(function(){
        ...
        $.post("<?php echo url('payment'); ?>",{orderid:orderid,pwd:pwd,total:total},function(data){
            if(data.info){
                location = "<?php echo url('chenggong'); ?>"
            }else{
                if(data.code == 400){
                    alert(data.msg)
                    return false
                }
                location = "<?php echo url('shibai'); ?>"
            }
        })
    })
})
