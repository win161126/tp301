<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"D:\WWW\tp0301/application/admin\view\brand\brandadd.html";i:1531120054;s:48:"D:\WWW\tp0301/application/admin\view\layout.html";i:1531280395;}*/ ?>
					...
					<div class="tab-content default-tab" id="tab2">
						...
						<form action="" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>描述</label>
									<textarea class="text-input textarea wysiwyg" id="textarea" name="description" cols="79" rows="5"></textarea>
								</p>
