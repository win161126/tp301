<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"D:\WWW\tp0301/application/index\view\cart\confirm.html";i:1531883629;s:55:"D:\WWW\tp0301/application/index\view\public\header.html";i:1531793643;s:55:"D:\WWW\tp0301/application/index\view\public\footer.html";i:1531359406;}*/ ?>
...
<div class="main">
    ...
    <ul class="gw_six">
        <?php if(is_array($addrlist) || $addrlist instanceof \think\Collection || $addrlist instanceof \think\Paginator): $i = 0; $__LIST__ = $addrlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
    	<li>
        	<label>
        	<div class="top">
            	<span><?php echo $v['linkman']; ?></span>
                <input type="checkbox" class="ck" value="<?php echo $v['id']; ?>"/>
            </div>
            <div class="bottom">
    ...
    <div class="gw_two">商品信息</div>
  	<table class="gw_three" cellpadding="0" cellspacing="0">
        ...
        <tr>
        	<td class="cz"><?php echo $v['id']; ?></td>
            <td>
                <a href="<?php echo url('Product/detail',['id'=>$v['pid']]); ?>" class="img"><img src="<?php echo $v['thumb']; ?>" /></a>
                <div class="left">
                    <a href="<?php echo url('Product/detail',['id'=>$v['pid']]); ?>"><?php echo $v['name']; ?></a><br />
                    <!-- 颜色 : 浅棕色 -->
                </div>
            </td>
            <td class="cz"><?php echo $v['num']; ?></td>
            <td class="price">¥ <?php echo $v['total']; ?></td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </table>
...
<div class="gw_four">
	<div class="main">
        ...
        <div class="right">
        	<p>商品数量总计 : <?php echo $num; ?>件</p>
            <p>商品金额总计（不含运费）:<span>¥ <?php echo $total; ?></span></p>
...
$(function(){
    $('.btn_order').click(function(){
        ...
        $.post("<?php echo url('orders'); ?>",{addressid:addressid,state:state},function(data){
            if(data.info){
