<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"D:\WWW\tp0301/application/admin\view\manager\manageradd.html";i:1531212901;s:48:"D:\WWW\tp0301/application/admin\view\layout.html";i:1531277110;}*/ ?>
					...
					<div class="tab-content default-tab" id="tab2">
						...
						<form action="" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								<p>
									<label>角色</label>
									<select name="rid" class="small-input">
								...
								<p>
									<label>密码</label>
										<input class="text-input small-input" type="password" id="small-input" name="pwd" /> 
								</p>
								<p>
									<label>确认密码</label>
										<input class="text-input small-input" type="password" id="small-input" name="pwd_confirm" /> 
								</p>
