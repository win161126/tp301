<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\WWW\tp0301/application/admin\view\role\roleupdate.html";i:1531193996;s:48:"D:\WWW\tp0301/application/admin\view\layout.html";i:1531189664;}*/ ?>
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						<li><a class="current" href="#">后台首页</a></li> <!-- Add class "current" to sub menu items also -->
						<li><a href="#">系统设置</a></li>
					</ul>
				</li>
				<li>
					...
					<ul>
						<li><a href="<?php echo url('Brand/brandAdd'); ?>">添加品牌</a></li>
						<li><a href="<?php echo url('Brand/brandList'); ?>">品牌列表</a></li>
					</ul>
				</li>
				<li>
					<a href="#" class="nav-top-item">
					...
					<ul>
						<li><a href="<?php echo url('Category/cateAdd'); ?>">添加分类</a></li>
						<li><a href="<?php echo url('Category/cateList'); ?>">分类列表</a></li>
					</ul>
				</li>
				<li>
					<a href="#" class="nav-top-item">
					...
					<ul>
						<li><a href="<?php echo url('Product/proAdd'); ?>">商品添加</a></li>
						<li><a href="<?php echo url('Product/proList'); ?>">商品列表</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li><a href="<?php echo url('Level/levelAdd'); ?>">添加权限</a></li>
						<li><a href="<?php echo url('Level/levelList'); ?>">权限列表</a></li>
					</ul>
				</li>
				<li>
					<a href="#" class="nav-top-item">
					...
					<ul>
						<li><a href="<?php echo url('Role/roleAdd'); ?>">添加角色</a></li>
						<li><a href="<?php echo url('Role/roleList'); ?>">角色列表</a></li>
					</ul>
				</li>
					...
					<div class="tab-content default-tab" id="tab2">
						...
						<form action="" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>权限</label>
									<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($v['fid'] == 0): ?>
										<h5><input type="checkbox" name="level[]" value="<?php echo $v['id']; ?>" <?php if(in_array($v['id'],$one['level'])): ?>checked="checked"<?php endif; ?>><?php echo $v['name']; ?></h5>
										<?php endif; if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;if($vv['fid'] == $v['id']): ?>
											<span><input type="checkbox" name="level[]" value="<?php echo $vv['id']; ?>" <?php if(in_array($vv['id'],$one['level'])): ?>checked="checked"<?php endif; ?>><?php echo $vv['name']; ?></span>
