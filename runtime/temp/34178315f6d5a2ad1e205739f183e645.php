<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"D:\WWW\tp0301/application/admin\view\product\prolist.html";i:1531724862;s:48:"D:\WWW\tp0301/application/admin\view\layout.html";i:1531811546;}*/ ?>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<form action="<?php echo url('proDelete'); ?>" method="post" name="mypro">
						<table>
							
							<thead>
								<tr>
								   <th><input class="check-all" type="checkbox" />序号</th>
								   <th>商品名称</th>
								   <th>简介</th>
								   <th>分类</th>
								   <th>品牌</th>
								...
								<tr>
									<td colspan="6">
										<div class="bulk-actions align-left">
											...
											<input type="submit" class="button" value="操作">
										</div>
							...
							<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a href="<?php echo url('Product/proUpdate',['id'=>$v['id']]); ?>" title="Edit"><img src="__PUBLIC__images/icons/pencil.png" alt="Edit" /></a>
										 <a href="<?php echo url('Product/proDelete',['id'=>$v['id']]); ?>" title="Delete"><img src="__PUBLIC__images/icons/cross.png" alt="Delete" /></a> 
